...
if [ -f "/Users/manson/go/bin/moai" ]; then
	exec "/Users/manson/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/manson/.local/bin/moai" ]; then
	exec "/Users/manson/.local/bin/moai" statusline < "$temp_file"
fi
